...
public class CanMessageFactory
  ...
  /*  public static Color getColor(byte[] farbnachricht){
      if(isByteArrayFarbNachricht(farbnachricht)){
        return null;
      }
      return null;
    }*/

/*  public static DriveMessage getDriveMessage(byte[] farbnachricht) {

  }*/
/*  public static RawColorMessage getRawColorMessage(DefaultCanMessage farbnachricht) {
    if(farbnachricht.getId()==RAW_COLOR_MESSAGE){
      byte[] b = new byte[16];
      int i;
      for (i = farbnachricht.length - 1; i >= 0; i--)
        if (farbnachricht[i] != ' ')
          break;
      for (int m = 0; m < 16; m++)
        b[m] = farbnachricht[i - 15 + m];
      return new RawColorMessage(new String(b));
    }
    return null;
  }*/

/*  public static DefaultCanMessage getDefaultCanMessage(byte[] content) {
//    if(message.length==27)
      return generateCanMessage(message);
//    return null;
  }*/
